...
var routes = [
    {
        path: '',
        component: form_select_component_1.FormSelectComponent,
        data: {
            title: 'Form Select',
            icon: 'icon-shortcode',
...
exports.FormSelectRoutingModule = FormSelectRoutingModule;
//# sourceMappingURL=form-select-routing.module.js.map