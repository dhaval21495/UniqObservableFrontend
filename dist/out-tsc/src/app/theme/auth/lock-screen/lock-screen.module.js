...
var lock_screen_routing_module_1 = require("./lock-screen-routing.module");
    ...
    LockScreenModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                lock_screen_routing_module_1.LockScreenRoutingModule,
...
exports.LockScreenModule = LockScreenModule;
